...
import { BookOpen, Sparkles, Calendar, Send, Heart, Smile, Flame, Award, Tag, Trash2 } from 'lucide-react';
...
export default function JournalPage({ user }) {
  ...
  return (
    <div className="space-y-10 max-w-5xl mx-auto w-full py-8 px-4 sm:px-8 pb-24">
